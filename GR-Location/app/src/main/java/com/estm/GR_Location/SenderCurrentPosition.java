...
public class SenderCurrentPosition extends AsyncTask<Void,Void,String> implements Serializable {
    public static  Context c;
//    public static  Context c2;
    String urlAddress;
  //  EditText IDtxt,lattxt,lngtxt;
    String ID,lat,lng;
  ...
  /* public static Trajet trajetObj ;
    ...
    public SenderCurrentPosition(){

    }*/
  //  ProgressDialog pdLoading ;
    public SenderCurrentPosition(  String address, String... editTexts) {

       this.urlAddress = address;
      //  pdLoading = new ProgressDialog(c) ;
        this.ID =editTexts[0];
        this.lat =editTexts[1];
        this.lng =editTexts[2];
...
/*
    public void JSON2OBJECTS(String response) {
        ...
        JSONObject jsonObj = new JSONObject(response);
            ...
            Toast.makeText(c,"From sender 2:"+ SenderCurrentPosition.getTrajetObj().toString(),Toast.LENGTH_LONG).show();
...
/*
    ...
    private String send()
    {
        ...
        try
        {
            ...
            bw.write(new DataPackagerCurrentPosition(ID,lat,lng).packData());
            bw.flush();
            //RELEASE RES
            bw.close();
            os.close();
