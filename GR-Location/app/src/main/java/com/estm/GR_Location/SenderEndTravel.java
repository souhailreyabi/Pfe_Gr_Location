...
public class SenderEndTravel extends AsyncTask<Void,Void,String> implements Serializable {
   ...
   public static Trajet trajetObj ;
    ...
    public SenderEndTravel(){

    }
    ProgressDialog pdLoading ;
    public SenderEndTravel(Context c, String address, EditText... editTexts) {
        this.c = c;
    ...
    public static void logout(boolean t){
       ...
       SenderEndTravel.trajetObj = null;
        SenderEndTravel.societeObj = null ;
        SenderEndTravel.listPauses = null ;
        SenderEndTravel.autocarObj = null ;
        SenderEndTravel.assistantObj = null ;
        SenderEndTravel.chauffeurObj = null ;
    ...
    public void JSON2OBJECTS(String response) {
        ...
        JSONObject jsonObj = new JSONObject(response);
            ...
            Toast.makeText(c,"From sender 2:"+ SenderEndTravel.getTrajetObj().toString(),Toast.LENGTH_LONG).show();
